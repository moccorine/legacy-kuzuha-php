  ...
  function runScript() {
    ...
    postContents.forEach((postContent) => {
      ...
      links.forEach((link) => {
        ...
        const previousSiblingText = link.previousSibling
          ? link.previousSibling.textContent.trim()
          : "";

        if (
          (!lineContent.startsWith(">") || !previousSiblingText.startsWith(">")) &&
          link.href.includes("up.heyuri.net") &&
          (link.href.includes("/src/") ||
            link.href.includes("/msrc/") ||
            link.href.includes("/gsrc/") ||
            link.href.includes("/gemusrc/") ||
            link.href.includes("/user/boards/"))
        ) {
