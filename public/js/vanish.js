...
var cookie = {
  get: function (n, m) {
    return (m = ("; " + document.cookie + ";").match("; " + n + "(.*?);"))
      ? decodeURIComponent(m[1])
      : "";
  },
  set: function (n, v) {
    document.cookie = n + "=" + encodeURIComponent(v) + "; expires=Mon, 31-Dec-2029 23:59:59 GMT";
  },
};
var vanisher = {
  init: function () {
  ...
  initNgWord: function (place) {
    ...
    this.ngWordLink.appendChild(
      document.createTextNode("Filtered words&nbsp;(" + this.ngWordCount + "&nbsp;hits)")
    );
